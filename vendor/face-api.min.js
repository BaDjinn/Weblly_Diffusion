!(function (t, e) {
				...
				return R(this, function (t) {
					switch (t.label) {
						...
						case 1:
							return (
								(e = t.sent()),
								[2, gt.buffer(this.shape, this.dtype, e)]
							);
					}
				});
			});
	...
	function wn(t) {
		...
		return (
			Object.defineProperty(n, "name", { value: r, configurable: !0 }),
			n
		);
	}
						...
						return (function (t, r, e, n) {
							...
							for (var f = {}, p = 0; p < r.variableNames.length; p++) {
								...
								((f[d] = t.getUniformLocation(c, d, !1)),
									(f["offset" + d] = t.getUniformLocation(
										c,
										"offset" + d,
										!1,
									)));
	...
	function Ts(t) {
		...
		if (null == t) {
			...
			((n.gpgpu = t),
				(n.binaryCache = {}),
				(n.gpgpuCreatedLocally = !1),
				(n.canvas = t.gl.canvas));
		return (
	...
	var Cu = wn({
		...
		Fu = wn({
			logicalXor_: function (t, e) {
				...
				return (
					go(n.shape, r.shape),
					Nu(t, e).logicalAnd(Au(t, e).logicalNot())
				);
			},
		}),
		Mu = wn({
		...
		lc = wn({
			lessEqualStrict_: function (t, e) {
				...
				return (
					x(n.shape, r.shape, "Error in lessEqualStrict: "),
					n.lessEqual(r)
				);
			},
		}),
		...
		pc = wn({
			notEqualStrict_: function (t, e) {
				...
				return (
					x(n.shape, r.shape, "Error in notEqualStrict: "),
					n.notEqual(r)
				);
			},
		});
	...
	var lh = wn({
		...
		gh = wn({
			fusedConv2d_: function (t) {
				...
				var C = { x: g, filter: m };
				(null != h && (C.bias = x),
					null != p && (C.preluActivationWeights = b));
				var E = [m, g],
					_ = Kt.runKernelFunc(
						function (t, e) {
							var n = t.fusedConv2d({
	...
	var Eh,
		_h =
			...
			(Ih.prototype.topk = function (t, e, n) {
				return (
					wh(t, "topk"),
					Ho(this.readSync(t.dataId), t.shape, t.dtype, e)
				);
			}),
			...
			removeModel: function (n) {
				return y(this, void 0, void 0, function () {
					...
					return R(this, function (t) {
						return (
							(e = Zh(n)),
							[2, $h.getManager(e.scheme).removeModel(e.path)]
						);
					});
				});
			},
							...
							[
								...
								u
									...
									.map(function (t) {
										...
										return (
											nv(i).putImageData(a.getImageData(e, n, r, o), 0, 0),
											i
										);
									}),
							]
	...
	function qg(t) {
		...
		return (
			Fv(t, e),
			{ params: { pnet: a, rnet: s, onet: u }, paramMappings: e }
		);
	}
	function jg(t, e) {
		var n = e[0],
